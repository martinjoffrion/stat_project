...
Le qqplot démontre la distribution uniforme des résidus.
La distribution par relevé est globalement uniforme d'après le graphique testCategorical.
Les résidus sont répartis de façon homogène d'après le graphique testQuantiles.

Les hypothèses du nouveau modèle sont donc vérifiées.
